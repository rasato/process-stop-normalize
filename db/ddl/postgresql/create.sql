...
COMMENT ON column SAMPLE_USER.STATUS is '処理ステータス';
ALTER TABLE BUSINESS_DATE ADD CONSTRAINT PK_BUSINESS_DATE PRIMARY KEY
(
  SEGMENT_ID
);
...
ALTER TABLE MAIL_TEMPLATE ADD CONSTRAINT PK_メールテンプレート PRIMARY KEY
(
  MAIL_TEMPLATE_ID,
  LANG
);
ALTER TABLE MAIL_ATTACHED_FILE ADD CONSTRAINT PK_メール添付ファイル PRIMARY KEY
(
  MAIL_REQUEST_ID,
  SERIAL_NUMBER
);
ALTER TABLE MAIL_RECIPIENT ADD CONSTRAINT PK_メール送信先 PRIMARY KEY
(
  MAIL_REQUEST_ID,
  SERIAL_NUMBER
);
ALTER TABLE MAIL_REQUEST ADD CONSTRAINT PK_メール送信要求 PRIMARY KEY
(
  MAIL_REQUEST_ID
);
...
ALTER TABLE BATCH_REQUEST ADD CONSTRAINT SYS_C0058579 PRIMARY KEY
(
  BATCH_REQUEST_ID
);
